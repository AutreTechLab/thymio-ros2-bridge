...
static const _Thymio2Controller_type_support_symbol_names_t _Thymio2Controller_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, thymio2_interfaces, msg, Thymio2Controller)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, thymio2_interfaces, msg, Thymio2Controller)),
  }
};
...
{
  return &::thymio2_interfaces::msg::rosidl_typesupport_cpp::Thymio2Controller_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, thymio2_interfaces, msg, Thymio2Controller)() {
  return get_message_type_support_handle<thymio2_interfaces::msg::Thymio2Controller>();
}
