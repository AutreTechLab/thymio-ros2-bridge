...
static const _Thymio2ControllerSrv_Request_type_support_symbol_names_t _Thymio2ControllerSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, thymio2_interfaces, srv, Thymio2ControllerSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, thymio2_interfaces, srv, Thymio2ControllerSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, thymio2_interfaces, srv, Thymio2ControllerSrv_Request)() {
  return &::thymio2_interfaces::srv::rosidl_typesupport_c::Thymio2ControllerSrv_Request_message_type_support_handle;
}
...
static const _Thymio2ControllerSrv_Response_type_support_symbol_names_t _Thymio2ControllerSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, thymio2_interfaces, srv, Thymio2ControllerSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, thymio2_interfaces, srv, Thymio2ControllerSrv_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_thymio2_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, thymio2_interfaces, srv, Thymio2ControllerSrv_Response)() {
  return &::thymio2_interfaces::srv::rosidl_typesupport_c::Thymio2ControllerSrv_Response_message_type_support_handle;
}
...
static const _Thymio2ControllerSrv_type_support_symbol_names_t _Thymio2ControllerSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, thymio2_interfaces, srv, Thymio2ControllerSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, thymio2_interfaces, srv, Thymio2ControllerSrv)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, thymio2_interfaces, srv, Thymio2ControllerSrv)() {
  return &::thymio2_interfaces::srv::rosidl_typesupport_c::Thymio2ControllerSrv_service_type_support_handle;
}
